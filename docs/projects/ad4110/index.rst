...
AD4110_SDZ HDL project
================================================================================

Overview
--------------------------------------------------------------------------------

The :adi:`AD4110` is a complete, single-channel, universal input
...
The :adi:`AD4110` provides internal front-end diagnostic functions to indicate
...
The :adi:`AD4110` incorporates a 24-bit sigma delta analog to digital converter
...
-  :adi:`EVAL-AD4110-1SDZ <EVAL-AD4110-1SDZ>`
